...
# This version completely omits LoRA config instead of setting lora_rank=0
...
# Force vLLM V0/legacy engine - V1 has incomplete multimodal support
# V0 properly initializes encoder cache for multimodal models
...
LR=1e-5
BSZ=4  # Reduced from 16 since no LoRA = more memory usage
GROUP_SIZE=2
ROLLOUT_TP_SIZE=1
