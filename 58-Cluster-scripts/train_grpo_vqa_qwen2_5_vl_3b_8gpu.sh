#!/bin/bash
# ============================================================================
# VQAv2 + Qwen2.5-VL-3B WITHOUT LoRA — 58-Cluster (8× GPU)
# ============================================================================
# Adapted from:
...
#
# Run with:
#   nohup bash train_grpo_vqa_qwen2_5_vl_3b_8gpu.sh > train_vqa_8gpu.log 2>&1 &
# ============================================================================
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vqa_qwen2_5_vl_3b_8gpu_full_ft_bsz8_lr1e6_gs4" \
