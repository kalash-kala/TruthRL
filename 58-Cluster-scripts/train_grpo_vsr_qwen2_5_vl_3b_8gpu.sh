...
# Using 8 GPUs and optimized parameters for Qwen2.5-VL-3B
# Run with: nohup bash train_grpo_vsr_qwen2_5_vl_3b_8gpu.sh > train_qwen2_5_vl_3b_8gpu.log 2>&1 &
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_qwen2_5_vl_3b_8gpu_optimized_bsz8_lr1e6_groupsize4" \
