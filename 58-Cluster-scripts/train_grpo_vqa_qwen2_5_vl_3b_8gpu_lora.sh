#!/bin/bash
# ============================================================================
# VQAv2 + Qwen2.5-VL-3B WITH LoRA — 58-Cluster (8× GPU)
# ============================================================================
# Adapted from:
#   - 2A100: train_grpo_vqa_qwen2_5_vl_3b_2gpu_a100_lora.sh  (VQA + LoRA + vLLM judge)
#   - 58-Cluster: train_grpo_vsr_qwen2_5_vl_3b_8gpu_lora_safe.sh  (cluster conventions)
#
# Uses LLM-as-Judge reward function (vqa_reward.py) with local vLLM judge
#
# Run with:
#   nohup bash train_grpo_vqa_qwen2_5_vl_3b_8gpu_lora.sh > train_vqa_8gpu_lora.log 2>&1 &
# ============================================================================
...
CUDA_VISIBLE_DEVICES=0,1 vllm serve "$JUDGE_MODEL_PATH" \
...
# ============================================================================
# Hyperparameters (from A100 LoRA script)
# ============================================================================
LR=1e-5
BSZ=8
GROUP_SIZE=4
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vqa_qwen2_5_vl_3b_8gpu_lora_bsz8_lr1e5_gs4_r128_alpha128" \
