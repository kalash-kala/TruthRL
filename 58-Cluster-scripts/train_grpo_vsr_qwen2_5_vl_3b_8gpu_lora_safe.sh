#!/bin/bash
# ============================================================================
# VSR + Qwen2.5-VL-3B WITH LoRA — 8× GPU (58-Cluster)
# ============================================================================
# Converted from NO_LORA script to use LoRA settings from A100 script
# Includes: safe tensor loading format, layered summon, and LoRA config
#
# Run with:
#   nohup bash train_grpo_vsr_qwen2_5_vl_3b_8gpu_lora_safe.sh > train_8gpu_lora_safe.log 2>&1 &
# ============================================================================
...
# ============================================================================
# PATHS (From 58-Cluster NO_LORA script)
# ============================================================================
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_qwen2_5_vl_3b_8gpu_lora_safe" \
