...
# NOTE: Do not cache device_name at module level! It must be detected at runtime
# within the worker process to ensure proper CUDA visibility from Ray workers.
