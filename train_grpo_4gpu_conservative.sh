# nohup bash train_grpo_4gpu_conservative.sh > train_grpo_4gpu_conservative.log 2>&1 &
set -x
...
# CONSERVATIVE 4-GPU CONFIGURATION
N_GPUS=4
ROLLOUT_TP_SIZE=2
...
KL_LOSS_COEF=0.001
BSZ=32  # Increased from 16 (1 GPU) - 2x scaling
GROUP_SIZE=6  # Increased from 4 - more rollouts for better GRPO
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='TruthRL-'$MODEL_NAME'_4GPU_Conservative_LoRA128' \
