#!/bin/bash
# ============================================================================
# VSR Open-Text + Qwen2.5-VL-3B WITH LoRA — 2× A100 Server
# ============================================================================
# Optimized for: 2 GPUs (A100 80GB), ~210GB System RAM
# Uses LLM-as-Judge reward function (vqa_reward.py) with local vLLM judge
# for open-ended spatial reasoning answers (not True/False)
#
# Run with:
#   nohup bash train_grpo_vsr_open_text_qwen2_5_vl_3b_2gpu_a100_lora.sh > train_vsr_open_text_2gpu_a100_lora.log 2>&1 &
# ============================================================================
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_DIR/train_open_text.parquet \
    ...
    trainer.project_name="TruthRL_VSR_OpenText" \
    trainer.experiment_name="vsr_open_text_qwen2_5_vl_3b_2gpu_a100_lora_bsz8_lr1e5_gs4_r128_alpha128" \
