#!/bin/bash
# ============================================================================
# VSR (DYNAMIC CONSISTENCY) + Qwen2.5-VL-3B WITH LoRA — 2× A100/H200 Server
# ============================================================================
# Optimized for: 2 GPUs with local vLLM judge server for dynamic consistency
# ============================================================================
...
REWARD_FN_PATH=/root/Desktop/kalashkala/TruthRL/training/verl/verl/utils/reward_score/vsr_dynamic_consistency.py
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_dynamic_consistency_qwen2_5_vl_3b_2gpu_a100_lora_bsz8_lr1e5_gs8_r128_alpha128" \
