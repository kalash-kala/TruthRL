#!/bin/bash
# ============================================================================
# VSR (DYNAMIC K) + Qwen2.5-VL-3B FULL PARAMETER WITHOUT LoRA — 2× H200 Server (KIAC)
# ============================================================================
#SBATCH --partition=h200
#SBATCH --account=sriramg
#SBATCH --qos=h200_qos
#SBATCH --gres=gpu:h200:2
#SBATCH --job-name=vsr_dynamic_k_qwen_full_bsz8_gs4_lr1e6_epochs2_k4_h200
...
export VERL_DYNAMIC_PENALTY_K=4
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_lexical_dynamic_k_qwen2_5_vl_3b_2gpu_h200_full_bsz8_lr1e6_gs4_k4" \
