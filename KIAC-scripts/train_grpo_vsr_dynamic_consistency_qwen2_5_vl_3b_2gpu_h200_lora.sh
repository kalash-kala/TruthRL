#!/bin/bash
# ============================================================================
# VSR (DYNAMIC CONSISTENCY) + Qwen2.5-VL-3B WITH LoRA — 2× H200 Server (KIAC)
# ============================================================================
#SBATCH --partition=h200
#SBATCH --account=sriramg
#SBATCH --qos=h200_qos
#SBATCH --gres=gpu:h200:2
#SBATCH --job-name=vsr_consistency_qwen_lora_2gpu_h200
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_consistency_qwen2_5_vl_3b_2gpu_h200_lora_bsz8_lr1e5_gs8" \
