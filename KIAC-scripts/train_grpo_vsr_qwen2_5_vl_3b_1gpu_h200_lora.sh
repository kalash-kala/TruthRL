#!/bin/bash
# ============================================================================
# VSR + Qwen2.5-VL-3B WITH LoRA — 1× H200 Server (KIAC)
# ============================================================================
#SBATCH --partition=h200
#SBATCH --account=sriramg
#SBATCH --qos=h200_qos
#SBATCH --gres=gpu:h200:1
#SBATCH --job-name=vsr_qwen_lora_bsz8_gs4_lr1e5_epochs3_h200
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_qwen2_5_vl_3b_1gpu_h200_lora" \
