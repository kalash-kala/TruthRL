#!/bin/bash
# ============================================================================
# VSR + Qwen2.5-VL-3B FULL PARAMETER WITHOUT LoRA — 2× H200 Server (KIAC)
# ============================================================================
#SBATCH --partition=h200
#SBATCH --account=sriramg
#SBATCH --qos=h200_qos
#SBATCH --gres=gpu:h200:2
#SBATCH --job-name=vsr_qwen_full_bsz8_gs4_lr1e6_epochs2_h200
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="vsr_qwen2_5_vl_3b_2gpu_h200_full_bsz8_lr1e6_gs4" \
